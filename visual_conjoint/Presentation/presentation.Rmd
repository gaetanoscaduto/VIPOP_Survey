...
date: "MethodsNET Conference, Louvain, October 2024"
output: 
  beamer_presentation:
...
- RQ 1: Are political inferences from apolitical cues still relevant for inferring politicians’ ideology when explicit political information, such as issue positions, is available?

- RQ 2: Are certain sociodemographic (gender, age, ethnicity, number of children, and occupation) or lifestyle (food and pet preferences) traits attributed to a politician perceived as associated with them being populists?
...
-   The only difference is in how the stimulus is presented.
...
-   Through this script, we generated 15.000 images.
...
-   Every respondent performs 5 tasks.
    -   For each task, the respondents are first asked:
        -   Which of the two politicians they consider more right-wing
        -   Which one they consider more populist.
...
In light of recent criticisms of the AMCE as an estimator for certain type of conjoint outcomes (Leeper et al., 2020; Ganter 2021), we will present the results relating to the dichotomous outcome with MMs and ACPs, but not with AMCEs.
